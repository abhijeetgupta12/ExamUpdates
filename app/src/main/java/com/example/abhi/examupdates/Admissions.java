...
public class Admissions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(Admissions.this, "Plz check your internet connection", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        public void run() {
            ...
            examUpdate.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    programmingList.setAdapter(new AdapterAdmission(Admissions.this,headline,url));
