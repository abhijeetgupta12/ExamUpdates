...
public class Results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(Results.this, "Plz check your internet connection", Toast.LENGTH_SHORT).show();
        }
        ...
        public void run() {
            ...
            examUpdate.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    programmingList.setAdapter(new AdapterResult(Results.this,headline,url));
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(Results.this,databaseError.toString(),Toast.LENGTH_LONG).show();
                    progressBar.setVisibility(View.INVISIBLE);
