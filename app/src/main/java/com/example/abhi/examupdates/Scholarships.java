...
public class Scholarships extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(Scholarships.this, "Plz check your internet connection", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        public void run() {
            ...
            examUpdate.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    programmingList.setAdapter(new AdapterScholarship(Scholarships.this,headline,url));
